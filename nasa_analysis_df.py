...
def main(log_file):
    ...
    data_frames['qty_http_404_per_day'] = splited_data_frame.filter('http_status = "404"').groupBy(splited_data_frame.timestamp.substr(1, 11).alias('day')).count().sort(desc('day'))
